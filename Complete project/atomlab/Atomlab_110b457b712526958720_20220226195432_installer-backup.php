...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Atomlab_110b457b712526958720_20220226195432_archive.zip';
	const ARCHIVE_SIZE		 = '27918076';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '110b457-26195432';
    const SECONDARY_PACKAGE_HASH = 'b4c25ea-26195432';
	const VERSION			 = '1.4.4';
